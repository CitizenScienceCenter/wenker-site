      ...
      children: [
        {
          path: 'transcription',
          name: 'Transcription',
          component: Project.Transcription,
          meta: {requiresAuth: false, breadcrumb: 'Transcription Project'},
        },
        {
          path: 'translation',
          name: 'Translation',
          component: Project.Translation,
          meta: {requiresAuth: false, breadcrumb: 'Translation Project'},
        },
