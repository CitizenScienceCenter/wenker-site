<i18n>
  ...
  "answer-1-bullet-1": "Sie können Ihre Arbeit auf einem anderen Computer fortsetzen.",
  "answer-1-bullet-2": "Sie erhalten Zugriff auf die Bögen, die Sie bereits transkribiert haben (unter Ihrem Profil).",
  "answer-1-bullet-3": "Sie können Ihre persönlichen Daten (Region, Altersbereich) speichern, damit Sie sie nicht jedes Mal erneut eingeben müssen.",
  "question-2": "Wie gehe ich beim Transkribieren vor?",
  "answer-2-text": "Zuerst haben Sie 2 Möglichkeiten:",
  "answer-2-bullet-1": "Sie können die Bögen in zufälliger Reihenfolge transkribieren.",
  "answer-2-bullet-2": "Sie können Bögen aus Orten innerhalb eines Kantons transkribieren.",
  "answer-2-text-2": "Wenn Sie keine Auswahl für Ihre Region treffen, erscheinen die Bögen aus unserer Datenbank in völlig zufälliger Reihenfolge.",
  "answer-2-text-3": "Der ausgewählte Bogen kann mit der Maus (oder dem Touchscreen) gescrollt werden, und Sie haben auch die Möglichkeit, das Bild zu vergrössern (zoomen), um es deutlicher zu machen.",
  ...
  "answer-4-text-3": "Wenn Sie auf einen Bogen in alter deutscher Schrift stossen, den Sie nicht lesen können, lassen Sie ihn aus. Vielleicht findet sich eine andere schriftkundige Person, die diesen Bogen transkribieren kann.",
  ...
  "answer-1-bullet-1": "Continue your work on a different computer.",
  "answer-1-bullet-2": "Access a history of sheets you have already transcribed (under your Profile).",
  "answer-1-bullet-3": "Save your region and age range so you do not have to enter it each time.",
  "question-2": "How do I do the transcription?",
  "answer-2-text": "First, you have 2 options:",
  "answer-2-bullet-1": "Transcribe all sheets in a random order.",
  "answer-2-bullet-2": "Transcribe sheets from a place within a canton.",
  "answer-2-text-2": "If you make no selection for your region, then you can go through all the sheets we have in our database, in a completely random order.",
  "answer-2-text-3": "The image of the sheet is scrollable with your mouse (or touch screen) and you also have the ability to zoom in or out to make it clearer.",
  ...
  "answer-4-text-3": "If you come across a sheet in old German script that you cannot read, leave it out. Perhaps there is another person who can transcribe this sheet.",
        ...
        <div class="row row-centered">
          <div class="col col-large-6">
            ...
            <div class="content-subsection">
              ...
              <p class="reduced-bottom-margin" v-html="$t('answer-1-text')"></p>
              <ul>
              ...
              <p class="reduced-bottom-margin" v-html="$t('answer-3-text-3')"></p>
              <ul>
                <li>ə</li>
                <li>Š</li>
                <li>š</li>
